 ...
 * CLI version: 2.8.1
 *
 * Generated: Sat, 14 Jan 2023 11:40:14 GMT
 */

var APP_com_sander_app_final_project = (function () {
  'use strict';
  ...
  class Boot extends Lightning.Component {
    static _template() {
      return {
        Background: {
          rect: true,
  ...
  class Cards extends Lightning.Component {
    static _template() {
      return {
        rect: true,
        h: 500,
  ...
  /* eslint-disable prettier/prettier */
  class Screens extends Lightning.Component {
    static _template() {
      return {
        rect: true,
        h: 200,
  ...
  class moviePage extends Lightning.Component {
    static _template() {
      return {
        Background: {
          rect: true,
  ...
  class App extends Router.App {
    static getFonts() {
      return [{
        family: 'Regular',
        url: Utils.asset('fonts/circular-reg.ttf')
      }, {
        family: 'Light',
        url: Utils.asset('fonts/CircularStd-Book.otf')
      }, {
        family: 'Bold',
        url: Utils.asset('fonts/CircularStd-Bold.ttf')
      }];
    }
